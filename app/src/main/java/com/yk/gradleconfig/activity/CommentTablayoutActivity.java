...
public class CommentTablayoutActivity extends AppCompatActivity {

    // https://blog.csdn.net/lufanzheng/article/details/60872068
    public static void start(Context context){
        Intent intent=new Intent(context,CommentTablayoutActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comment_tablayout);
